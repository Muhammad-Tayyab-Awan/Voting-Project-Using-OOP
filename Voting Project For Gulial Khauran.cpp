...
int main()
{
    ...
    int no_o_officers = officers_data_fetching(Officers);
    int no_o_voters = fetch_voters_data(Voters);
    ...
    {
        int data_validation = Officers_Validation();
        if (data_validation == 5)
        {
            comparision = Compare_Officers_data(no_o_officers, Officers);
            if (comparision == 5)
            {
                ...
                while (action != 2)
                {
                    ...
                    case 1:
                        ...
                        else
                        {
                            ...
                            voter_verification = voters_verification(no_o_voters, Voters);
                            ...
                            {
                                polled_voter_verifiction = polled_voters(no_o_voters, voter_verification, Polled_Voters);
